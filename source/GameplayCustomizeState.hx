...
class GameplayCustomizeState extends MusicBeatState
{
    ...
    public override function create() {
        ...
        blackBorder = new FlxSprite(-40,FlxG.height + 40).makeGraphic((Std.int(text.width + 900)),Std.int(text.height + 600),FlxColor.BLACK);
    ...
    override function update(elapsed:Float) {
        ...
        camHUD.zoom = FlxMath.lerp(0.95, camHUD.zoom, 0.95);
