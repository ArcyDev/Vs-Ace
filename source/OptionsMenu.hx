...
class OptionsMenu extends MusicBeatState
{
	...
	var options:Array<OptionCategory> = [
		...
		new OptionCategory("Appearance", [
			new DistractionsAndEffectsOption("Toggle blizzard effect that can hinder your gameplay and reduce performance."),
			new SnowfallOption("Toggle background snowing effect that can reduce performance."),
